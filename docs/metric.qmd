...
# Create a registry instance to access built-in metrics
registry = MetricRegistry()

# Create a Polars DataFrame of built-in metrics
metrics_data = [
    {"name": name, "expression": str(registry.get_metric(name))} 
    for name in sorted(registry.list_metrics())
]
...
# Use the same registry instance to access built-in selectors
selectors_data = [
    {"name": name, "expression": str(registry.get_selector(name))} 
    for name in sorted(registry.list_selectors())
]
