...
from data_generator import create_expanded_clinical_data

# Create sample dataset with comprehensive structure for pivot examples
df = create_expanded_clinical_data()
df
```
...
evaluator_group_sub = MetricEvaluator(
    ...
    metrics=mixed_metrics,
    ground_truth="actual",
    estimates={"model_1": "Model 1", "model_2": "Model 2"},
    group_by={"treatment": "Treatment", "region": "Region"},
