...
class MetricEvaluator:
    ...
    def _evaluate_single_with_subgroup(
        self, metric: MetricDefine, estimate: str, subgroup_var: str
    ) -> pl.LazyFrame:
        """
            ...
            for subgroup_var in self.subgroup_by:
                for estimate in estimates_to_eval:
                    for metric in metrics_to_eval:
                        ...
                        result = self._evaluate_single_with_subgroup(
                            metric, estimate, subgroup_var
                        )
    ...
    def _get_grouping_columns(
        self, metric_type: MetricType, scope: MetricScope | None, estimate: str
        ...
        grouping_rules = {
            ...
            MetricType.ACROSS_SUBJECT: (
                ["subject_id"] + effective_group_by,
                effective_group_by,
            ),
            MetricType.WITHIN_VISIT: (
                ["subject_id", "visit_id"] + effective_group_by,
                None,
            ),
